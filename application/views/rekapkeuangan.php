                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <form id="cariRekap" method="POST" role="form" action="<?php echo site_url('RincianController/rekapkeuangan'); ?>">
                                ...
                                <button id="btnFindRekap" name="submit" class="btn btn-primary" type="submit" form="cariRekap" value="Submit"><span class="icon text-white-50"><i class="fas fa-sm fa-search"></i></span><span class="text"> cari</span></button>
                            </form>
                        </div>
                        <div class="card-body">
